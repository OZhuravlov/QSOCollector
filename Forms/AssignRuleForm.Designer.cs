...
namespace QSOCollector.Forms
{
    partial class AssignRuleForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            assignRuleDataGridView = new DataGridView();
            ...
            assignRuleHintLabel = new Label();
            ((System.ComponentModel.ISupportInitialize)assignRuleDataGridView).BeginInit();
            SuspendLayout();
            // 
            // assignRuleDataGridView
            // 
            assignRuleDataGridView.AllowUserToAddRows = false;
            assignRuleDataGridView.AllowUserToDeleteRows = false;
            assignRuleDataGridView.BackgroundColor = SystemColors.ControlLightLight;
            assignRuleDataGridView.CellBorderStyle = DataGridViewCellBorderStyle.Raised;
            ...
            assignRuleDataGridView.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle1;
            assignRuleDataGridView.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            assignRuleDataGridView.Columns.AddRange(new DataGridViewColumn[] { id, ruleName, origFreqFrom, origFreqTo, propagationMode, satName, satMode, targetBand, targetBandRx, targetfreqTx, targetFreqRx, isActive });
            ...
            assignRuleDataGridView.DefaultCellStyle = dataGridViewCellStyle2;
            assignRuleDataGridView.Location = new Point(4, 5);
            assignRuleDataGridView.MultiSelect = false;
            assignRuleDataGridView.Name = "assignRuleDataGridView";
            assignRuleDataGridView.ReadOnly = true;
            ...
            assignRuleDataGridView.RowHeadersDefaultCellStyle = dataGridViewCellStyle3;
            ...
            assignRuleDataGridView.RowsDefaultCellStyle = dataGridViewCellStyle4;
            assignRuleDataGridView.Size = new Size(832, 150);
            assignRuleDataGridView.TabIndex = 2;
            assignRuleDataGridView.SelectionChanged += AssignRuleDataGridView_SelectionChanged;
            // 
            // id
            // 
            ...
            CancelButton.Location = new Point(213, 167);
            CancelButton.Name = "CancelButton";
            CancelButton.Size = new Size(148, 35);
            ...
            AssignRuleButton.Location = new Point(488, 167);
            AssignRuleButton.Name = "AssignRuleButton";
            AssignRuleButton.Size = new Size(198, 35);
            AssignRuleButton.TabIndex = 4;
            AssignRuleButton.Text = "Assign Selected Rule";
            AssignRuleButton.UseVisualStyleBackColor = true;
            AssignRuleButton.Click += AssignRuleButton_Click;
            // 
            // assignRuleHintLabel
            // 
            assignRuleHintLabel.AutoSize = true;
            assignRuleHintLabel.Font = new Font("Segoe UI Semibold", 9F, FontStyle.Bold | FontStyle.Italic, GraphicsUnit.Point, 0);
            assignRuleHintLabel.Location = new Point(502, 205);
            assignRuleHintLabel.Name = "assignRuleHintLabel";
            assignRuleHintLabel.Size = new Size(169, 15);
            assignRuleHintLabel.TabIndex = 7;
            ...
            ClientSize = new Size(840, 252);
            Controls.Add(assignRuleHintLabel);
            Controls.Add(AssignRuleButton);
            Controls.Add(CancelButton);
            Controls.Add(assignRuleDataGridView);
            MaximizeBox = false;
            MinimizeBox = false;
            Name = "AssignRuleForm";
            Text = "Assign SAT Rule";
            Load += AssignRuleForm_Load;
            ((System.ComponentModel.ISupportInitialize)assignRuleDataGridView).EndInit();
            ResumeLayout(false);
            PerformLayout();
        }
        ...
        private DataGridView assignRuleDataGridView;
        ...
        private Label assignRuleHintLabel;
